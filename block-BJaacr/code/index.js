...
for (let nameandsize of got.houses){
  console.log(`${nameandsize.name}: ${nameandsize.people.length}`)
}
...
for(let lengthofDescription of allDescription){
  if(lengthofDescription.length >= 30){
    console.log(lengthofDescription)
  }
}