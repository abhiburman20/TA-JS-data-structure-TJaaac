...
// - Add a new key with the name stored in variable `keyName` defined below i.e `playedBy` 
//(use [] for computed property) and the value of "Maisie Williams"
...
character.keyName= alert(character.playedBy);
