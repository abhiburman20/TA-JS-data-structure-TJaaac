...
// yes, we can define the key named with any javascript keyword because in objects keys are just something which holds the value it can be number or any name.
